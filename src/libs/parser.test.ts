...
test.each([
	...
	['1elm cms', { world: 1, location: 'ELM', tents: ['C', 'M', 'S'] }],
	['1 c/m/s', { world: 1, tents: ['C', 'M', 'S'] }],
	['1 cons/mining/smithing', { world: 1, tents: ['C', 'M', 'S'] }],
	['1 cons mining smithing', { world: 1, tents: ['C', 'M', 'S'] }],
	['1 herb farm', { world: 1, tents: ['H', 'F'] }],
	['1 herb', { world: 1, tents: ['H'] }],
	...
	['1 ruin', { world: 1, state: 'broken' }],
	['1 dead', { world: 1, state: 'dead' }],
	['60 empty', { world: 60, state: 'empty' }],
	['60 emptied', { world: 60, state: 'empty' }],
